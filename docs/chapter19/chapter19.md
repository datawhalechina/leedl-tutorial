...
![image](B480DF76DD5448D3AF6BA4F0F7D29748)
...
用不干的data来做domain其他的data，来帮助现在的task，是有可能的。



![image](5657A8058307473ABDC5361C602D3A8B)
我们在现实生活中，我们在不断的做transfer learning。比如说：你可能是是一名研究生，你可能想知道研究生咋样过日子，你就可以参考爆漫王里面的例子。在爆漫王里面漫画家就是研究生，责编就等同于指导教授。漫画家每周画分镜去给责编看，跟责编讨论(就跟指导教授每周去汇报报告一样)，画分镜就是跑实验。目标就是投稿就等于投稿期刊。

虽然我们没有一个研究生的守则，但是从爆漫王里面我们可以知道说：身为一个研究生应该要做什么样的事情。那你可能会说：拿漫画跟学术做类比，有点不伦不类的(漫画也是拿生命来做的)。


![image](64A0F1372F6C4BCE9E15145DF8FFD7C8)
...
![image](4F3F6AFE402D48AF9F765AFD865CAFA3)
...
![image](55819217AE5D4AED838A42AF240B4CEB)
...
![image](8D3221BDC46E4721AC9AA0C2FF833745)
...
![image](F752AB62A7D449B99C85A11FD11C06CE)
...
![image](A0AA019D65E14FA29A94D6F77813B6B8)
...
![image](3D7A463FE9244960A2FBEC9EB04CE459)
...
![image](D4F8B764E3B84C6AA93BC79E3B428366)
...
![image](D6CA313982BC4B098764EBB9029C9331)
...
![image](AD368C7312714D2E9727EFFB1A399FBB)
...
![image](D8177976EC434994AFD133A0E0D63E72)
...
![image](E240FFEE5B294E2ABC93DED2FDABB262)
接下来是：假设target data是unlaebl，而source data是label的时候我们可以做什么样的事情



![image](0760BCE284834C3389BF6B5E7FED27D4)
...
![image](92E29BE2F4214701954A6211C8EFA86D)
...
![image](D59EFD6D787242B7B0738EBFB62717F0)
...
![image](ABEBDAA71F994E33BA848287218DA806)
...
所以今天你的feature extract 不只要骗过domain classifier，还要满足label predictior的需求。抽出的feature不仅要把domain的特性消掉，同时还要保留原来feature的特性。那我们把这三个neural放在一起的话。实际上就是一个大型的neural network，是一个各怀鬼胎的neural network(一般的neural network整个参数想要做的事情都是一样的，要minimize loss)，在这个neural network里面参数是各怀鬼胎的。蓝色label predictor做的事情是把class分类做的正确率越高越好，domain classifier做的事情是想正确predict image是属于哪个domain。feature extractor想要做的事情是：要同时improve label predictor，同时想要minimize domain classifier accuracy。


![image](68EA079B41F74DFD800CAFBC126EF87D)
...
![image](19CD7A0AE0E4417182F568CA1A046995)
...
![image](02EFBFC324FD4B06A290C7B9767EC54C)
...
![image](A997A82A4E7A42869077D11A99EB04DE)
...
![image](A15AB915647D4F769232ACEBB058EC13)
...
![image](2C4C2AFDC8614E4BBE04C9211F4D4AC3)
...
![image](EFE191597AEB45B0925BCE2CD898B8E4)
...
![image](D7E938B234A9470AB783062ED0363E21)
...
![image](4B6F6B6DE319418B926C43F33A6C8FFF)
...
![image](9C6A9FD1BE2946E482D4E501FD55B20E)
...
![image](02E088AC07F04A75A96B4ED90417D902)
一些paper给予参考。


![image](6AD6A0D65DFA4B1389E05DA8D45A97EF)
...
![image](3BDD7992AE4244A2ADFC32DC05F88CA5)
